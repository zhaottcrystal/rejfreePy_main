...
class ExactInvarianceTest:
    ...
    def main():
        ...
        np.savetxt("/home/zhaott/project/zhaott/rejfreePy_main/EIT/fExchange.csv", fExchangeCoef, fmt='%.3f', delimiter=',')
        ...
        stationaryWeightsBPS = HTransitionSampleBPS['stationaryWeightsSamples']
        exchangeCoefBPS = HTransitionSampleBPS['ExchangeableCoefSamples']
        stationaryDistBPS = HTransitionSampleBPS['StationaryDistSamples']
        binaryWeightsBPS = HTransitionSampleBPS['binaryWeightsSamples']
        np.savetxt("/home/zhaott/project/zhaott/rejfreePy_main/EIT/bpsStationaryWeights.csv", stationaryWeightsBPS, fmt='%.3f', delimiter=',')
        np.savetxt("/home/zhaott/project/zhaott/rejfreePy_main/EIT/bpsStationaryDist.csv", stationaryDistBPS, fmt='%.3f', delimiter=',')
        np.savetxt("/home/zhaott/project/zhaott/rejfreePy_main/EIT/bpsBinaryWeights.csv", binaryWeightsBPS, fmt='%.3f', delimiter=',')
